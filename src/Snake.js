...
const CENTER_GRID = (globals.NUM_OF_SECTIONS + 1)/2; // finds center of grid to show snake starts
...
export class Snake {
    ...
    createHead(){
        ...
        var headBlock = new Block(CENTER_GRID, CENTER_GRID,GAME_COLORS.SNAKE_HEAD,globals.SNAKE_CURVE);
    ...
    grow() {
        ...
        var newBlock = new Block(newR,newC,GAME_COLORS.SNAKE_TAIL,globals.SNAKE_CURVE);
    ...
    move(){
         if(this.isMoving){
            ...
            if (this.eatingSelf() /*|| this.reachedTheWall()*/) {
                ...
                globals.STATS.SNAKE_STATUS = "eating self";
                globals.STATS.GAME_STATUS = " ; GAME OVER!!!";
            }
